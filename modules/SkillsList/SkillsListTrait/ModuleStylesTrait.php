<?php
/**
 * Module styles trait for Skills List.
 *
...
trait ModuleStylesTrait {
	...
	/**
	 * Generate styles for the Skills List module.
	 *
	 * @since 0.5.0
	 *
	...
	public static function module_styles( array $args ): void {
		...
		$grid_selector = "{$order_class} .leaderspath_skills_list__grid";
		...
		$icon_selector = "{$order_class} .leaderspath_skills_list__card_icon";
