<?php
/**
 * CourseActivities::module_styles()
 *
...
/**
 * Module styles trait for CourseActivities.
 *
 * @since 0.1.0
 */
trait ModuleStylesTrait {
	...
	/**
	 * CourseActivities Module's style components.
	 *
	 * This function is equivalent of JS function ModuleStyles located in
	 * src/components/course-activities/styles.tsx.
	 *
	 * @since 0.1.0
	 *
	 * @param array $args {
				...
				'styles'        => [
							...
							'styleProps' => [
								...
								'advancedStyles' => [
									[
										...
										'props'         => [
											'selector' => "{$order_class} .leaderspath-course-activities__content",
					...
					CssStyle::style(
						[
							...
							'attr'      => $attrs['css'] ?? [],
							'cssFields' => CourseActivities::custom_css(),
						]
					),
				],
			]
