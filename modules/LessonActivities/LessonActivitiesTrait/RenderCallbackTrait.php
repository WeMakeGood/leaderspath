<?php
/**
 * LessonActivities::render_callback()
 *
 * Displays Lesson activities from the lesson_activities relationship field.
 *
...
/**
 * Render callback trait for LessonActivities.
 *
 * Displays activities for the current Lesson as an ordered list with links.
 *
 * @since 0.1.0
 */
trait RenderCallbackTrait {
	...
	/**
	 * Get lesson activities from ACF relationship field.
	 *
	 * @since 0.1.0
	 *
	...
	public static function get_activities(): array {
		...
		$related_activities = get_field( 'lesson_activities', $post_id );
	...
	/**
	 * Lesson Activities module render callback which outputs server side rendered HTML.
	 *
	 * @since 0.1.0
	 *
	 ...
	 *
	 * @return string HTML rendered of Lesson Activities module.
	 */
	public static function render_callback( $attrs, $content, $block, $elements ): string {
		...
		$content_html = HTMLUtility::render(
			[
				...
				'tagEscaped'        => true,
				'attributes'        => [
					'class' => 'leaderspath-lesson-activities__content',
				],
		...
		return Module::render(
			[
				...
				'classnamesFunction' => [ LessonActivities::class, 'module_classnames' ],
				'stylesComponent'    => [ LessonActivities::class, 'module_styles' ],
	...
	private static function render_empty_state( array $attrs, $elements ): string {
		...
		return HTMLUtility::render(
			[
				...
				'tagEscaped'        => true,
				'attributes'        => [
					'class' => 'leaderspath-lesson-activities__empty',
				],
				'childrenSanitizer' => 'et_core_esc_previously',
	...
	private static function render_activities_list( array $attrs, $elements, array $activities ): string {
		...
		foreach ( $activities as $index => $activity ) {
			...
			$link_html  = HTMLUtility::render(
				[
					...
					'tagEscaped'        => true,
					'attributes'        => [
						'class' => 'leaderspath-lesson-activities__link',
			...
			$number_html = HTMLUtility::render(
				[
					...
					'tagEscaped'        => true,
					'attributes'        => [
						'class' => 'leaderspath-lesson-activities__number',
					],
					'childrenSanitizer' => 'esc_html',
			...
			$items_html .= HTMLUtility::render(
				[
					...
					'tagEscaped'        => true,
					'attributes'        => [
						'class' => 'leaderspath-lesson-activities__item',
					],
					'childrenSanitizer' => 'et_core_esc_previously',
		...
		return HTMLUtility::render(
			[
				...
				'tagEscaped'        => true,
				'attributes'        => [
					'class' => 'leaderspath-lesson-activities__list',
				],
				'childrenSanitizer' => 'et_core_esc_previously',
				'children'          => $items_html,
			]
