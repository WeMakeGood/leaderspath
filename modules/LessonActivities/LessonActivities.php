<?php
/**
 * Module: Lesson Activities class.
 *
 * Displays the ordered list of activities for a lesson from the lesson_activities
...
/**
 * LessonActivities module class.
 *
 * This module displays an ordered list of activities from the lesson_activities
...
class LessonActivities implements DependencyInterface {
	...
	use LessonActivitiesTrait\ModuleClassnamesTrait;
	use LessonActivitiesTrait\ModuleStylesTrait;
	use LessonActivitiesTrait\CustomCssTrait;

	/**
	 * Loads LessonActivities and registers Front-End render callback.
	 *
	 * @since 0.1.0
	 *
	 * @return void
